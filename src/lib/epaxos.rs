...
impl Payload {
    ...
    pub fn get_write_req(&self) -> &WriteRequest {
        self.write_req.as_ref().unwrap_or_else(|| <WriteRequest as ::protobuf::Message>::default_instance())
    }
...
impl AcceptOKPayload {
    ...
    pub fn get_command(&self) -> &WriteRequest {
        self.command.as_ref().unwrap_or_else(|| <WriteRequest as ::protobuf::Message>::default_instance())
    }
...
impl ::protobuf::Message for AcceptOKPayload {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<AcceptOKPayload>(
                "AcceptOKPayload",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static AcceptOKPayload {
        static instance: ::protobuf::rt::LazyV2<AcceptOKPayload> = ::protobuf::rt::LazyV2::INIT;
